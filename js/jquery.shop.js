(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.currency = "AFA"; // HTML entity of the currency to be displayed in the layout
			this.currencyString = "AFA"; // Currency symbol as textual string
			this.paypalCurrency = "AFA"; // PayPal's currency code
		...
		sendEmail: function() {
			if( this.$checkoutCart.length && this.$userDetails.length ) {
				...
				if( items.length == 0 ) {
					...
					var uemail = 'ankithrealtor@gmail.com';
